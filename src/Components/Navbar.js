...
//   const navColor = {
//     backgroundColor: '#333 !important', // Dark background color
  ...
  <div className="container-fluid">
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li className="nav-item">
          <a className="nav-link" href="/"><strong>Link</strong></a>
        </li>
        ...
        <li className="nav-item">
          <a className="nav-link disabled" aria-disabled="true" href='/'><strong>Disabled</strong></a>
        </li>
      </ul>
